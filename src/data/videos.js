// src/data/videos.js          ← this is the file App.jsx is looking for
const gsVideos = [
  // Geography
  {
    id: 1,
...
export default gsVideos;


//const categories = ["All", "Polity", "History", "Geography", "Economics", "Science", "Scheme", "Current Affairs","Static GK"];